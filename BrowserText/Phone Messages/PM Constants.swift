...
let nutritionBadBits = ["Nutrition history\n", "Advanced directives", "Developmental history/n", "Family health history"]
...
let employeeNameBadBits = ["Help", "None", "MA", "LVN"]
