...
let noShowVerbiage = """
Our records indicate you recently missed an appointment at our office.  Please call our office and we will be happy to schedule another appointment for you.  Any time you are unable to keep an appointment, we would appreciate a call in advance so we can use that appointment time for another patient.
